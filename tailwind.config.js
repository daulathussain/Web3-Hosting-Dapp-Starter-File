...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        colored:
          "0 10px 25px -3px rgba(139, 92, 246, 0.1), 0 4px 6px -2px rgba(139, 92, 246, 0.05)",
        "colored-lg": "0 20px 40px -12px rgba(139, 92, 246, 0.25)",
        "inner-colored": "inset 0 2px 4px 0 rgba(139, 92, 246, 0.06)",
      },
      backdropBlur: {
        xs: "2px",
      },
